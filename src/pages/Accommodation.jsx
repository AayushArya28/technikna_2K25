...
export default function Accommodation() {
  ...
  }, [entitlementsLoading, canAccessAccommodation, popup, navigate]);
          ...
          <section className="grid gap-6 md:grid-cols-2">
            ...
            <div className="rounded-2xl border border-white/10 bg-gradient-to-br from-emerald-500/30 via-green-500/20 to-teal-500/25 p-6 shadow-lg shadow-black/40">
              ...
              <p className="mt-3 text-white/80">
                Tell us your dates, group size, and preferences. We will respond
                with the best available options and next steps.
              </p>

              <button
                onClick={() => setOpenForm(true)}
                className="mt-6 inline-flex w-fit items-center gap-2 rounded-full bg-white px-5 py-2.5 text-black font-medium transition hover:-translate-y-[1px] hover:bg-white/90"
              >
                Submit stay request
              </button>
            </div>
