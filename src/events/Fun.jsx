...
const events = [
  {
    ...
    groupMaxTotal: 4,
    rulebookText:
      "Rulebook\n\n1. Teams of 3–4 will be locked inside a guarded fortress.\n2. Hidden scrolls, symbols, and challenges help you escape before the final gong.\n3. No prior knowledge required — every clue needed lies within the room.\n4. No food or snacks inside.\n5. No forceful destruction of props/locks. Damaging items leads to disqualification.\n6. You have 25 minutes. Escape time is recorded on the leaderboard.\n7. Up to 3 hints allowed; each hint adds 4 minutes to your final time.\n8. No brute force — if it doesn’t move easily, it’s not required.\n9. Do not attempt to break locks; find the combination/key.\n10. Do not reveal puzzles/solutions to others.",
  },
];
